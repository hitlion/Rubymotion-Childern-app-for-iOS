class OverlayViewModuleIPhoneStylesheet < ApplicationStylesheet
  def setup
  end
  ...
  def background_layer (st)
    st.frame = {t: 0.0 * device.screen_height, l: 0.2 * device.screen_width, fr: 0.2 * device.screen_width, fb: 0.0 * device.screen_height}
