class OptionViewIPhoneStylesheet < ApplicationStylesheet
  def setup
  end

  def root( st )
    st.frame = {l: device.screen_width, t: 0.15 * device.screen_height, w: 1 * device.screen_width, h: 0.875 * device.screen_height}
    st.alpha = 1.0
